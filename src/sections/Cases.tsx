      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-16">
          {cases.map((item, index) => (
            <Reveal key={index} delay={index * 0.08}>
              <div className="border border-white/[0.04] bg-white/[0.02] backdrop-blur-xl rounded-3xl p-6 hover:bg-white/[0.04] transition-all duration-300">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 mt-16">
          {[
            ...
            <Reveal key={index} delay={index * 0.08}>
              <div className="border border-white/[0.04] bg-white/[0.02] rounded-3xl p-6">
